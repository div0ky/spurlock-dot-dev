...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"Aaron J. Spurlock - Vue Certified Developer, Head of Technology, and System Architect"}],"link":[],"style":[],"script":[{"innerHTML":"\n            (function() {\n              if (localStorage.getItem('theme') === 'light') {\n                document.documentElement.classList.remove('dark');\n              }\n            })();\n          ","type":"text/javascript"}],"noscript":[],"htmlAttrs":{"class":"dark"},"title":"Spurlock.dev | Developer Portfolio"};
