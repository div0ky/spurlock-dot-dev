...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "7d7c460b-140a-4c4a-980a-9a55390665f2",
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "/Users/ajspurlock/git/wizards/spurlock-dot-dev/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  },
  "ipx": {
...
const checksums = {
  "blog": "v3.5.0--ZC6ICMA9UD9UYe7nDlNTnHoErbCFhxu-eA2l4OTBvL8",
  "projects": "v3.5.0--HUngmAkLqtYw_HtRNvriOL6oCI4uPig3fe1XnEGAKR0"
};
const checksumsStructure = {
  "blog": "0i_Cld5OYw37yb8vWghpbmMClTEf9yfKf8VEauhN9cc",
  "projects": "PFAQ1YyxZjIGTIxR0q8lm0_g51ydXShfX2kEOjvkqDo"
};
...
const __B8caF = defineCachedEventHandler(async (event) => {
...
const _FLu8Tn = eventHandler(async (event) => {
...
const _UiXl3q = eventHandler(async (event) => {
...
const _2CvqSL = lazyEventHandler(() => {
...
const _lazy_ilXAMk = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_ilXAMk, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: __B8caF, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/sql_dump.txt', handler: _FLu8Tn, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/query', handler: _UiXl3q, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _2CvqSL, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_ilXAMk, lazy: true, middleware: false, method: undefined }
];
