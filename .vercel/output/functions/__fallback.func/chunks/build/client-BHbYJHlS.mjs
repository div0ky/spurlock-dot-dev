...
import { B as withoutTrailingSlash } from '../nitro/nitro.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<span${ssrRenderAttrs(mergeProps({
        class: ["inline-flex items-center rounded-lg transition-colors", [variantClasses[__props.variant], sizeClasses[__props.size]]]
      }, _attrs))}>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/m3/M3Badge.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const __nuxt_component_2 = Object.assign(_sfc_main, { __name: "M3Badge" });
const checksums = {
...
export { __nuxt_component_2 as _, queryCollection as q };
//# sourceMappingURL=client-BHbYJHlS.mjs.map
